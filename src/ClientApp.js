...
import background from "./images/background/main_background.svg"
import {
    ABOUT_PAGE, AUTHORIZE_PAGE,
    BLACK_FILTER,
    CART_PAGE, CLIENT_CHATS_PAGE,
    COLLECTION_PAGE, CREATE_ORDER_PAGE,
    DELIVERY_PAGE,
    MAIN_PAGE, ORDERS_PAGE, PRODUCT_PAGE,
...
import ClientChats from "./components/chats/ClientChats";
...
function ClientApp() {
    ...
    const getContent = (activePage, action) => {
        ...
        if (activePage === PROFILE_PAGE) {
            return <Profile onUnauthorize={onUnauthorizedHandler} onChangePage={clickNavButtonHandler}/>
        }
