...
import {
    ...
    CREATE_ORDER_PAGE,
    DELIVERY_PAGE,
    MAIN_PAGE, ORDERS_PAGE,
    PROFILE_PAGE,
    QUIZ_PAGE
} from "../../utils/Constants";

const getLogo = (currentPage) => {
    const logos = [ABOUT_PAGE, MAIN_PAGE, DELIVERY_PAGE, QUIZ_PAGE, CART_PAGE, PROFILE_PAGE, CREATE_ORDER_PAGE, ORDERS_PAGE, CLIENT_CHATS_PAGE]
                ...
                <div className={styles['header-container']}>
                    ...
                    <div className={styles["header-buttons"]}>
                        ...
                        <div className={styles["header__icon-btn"]}>
                            ...
                            <IconNavbarButton onClick={() => props.onClickNavButton(CLIENT_CHATS_PAGE)} src={MessagesIcon}/>
                        </div>
                    </div>
                </div>
            </div>
